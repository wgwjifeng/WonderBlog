...
function dreamway_defaults( $defaults ) {
	...
	$defaults['footer_text'] = '<a href="' . __( 'http://wordpress.org/', 'dreamway' ) . '">' . __( 'Powered by WordPress', 'dreamway' ). '</a> | ' . __( 'theme ', 'dreamway' ) . '<a href="' .  __( 'http://wpblogs.ru/themes/blog/theme/dream-way/', 'dreamway') . '">Dream Way</a>';
