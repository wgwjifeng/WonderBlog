...
function inkthemes_plugins_notify() {
     ...
     */
    $config = array(
        'domain' => 'colorway', // Text domain - likely want to be the same as your theme.
        ...
        'strings' => array(
            ...
            'installing' => __('Installing Plugin: %s', 'colorway'), // %1$s = plugin name
            ...
            'return' => __('Return to recommend Plugins Installer', 'colorway'),
            'plugin_activated' => __('Plugin activated successfully.', 'colorway'),
            'complete' => __('All plugins installed and activated successfully. %s', 'colorway') // %1$s = dashboard link
        )
    );
