            ...
            <div id="import_options" class="setting_option">  
                ...
                <div class="settings_toggle_inner">
                   ...
                   <form action="" method="post" enctype="multipart/form-data">
                        <p><input type="file" name="file" id="importbutton" /> <input type="submit" name="import" id="importoptions" class="button-primary" value="<?php _e('Import', 'optimizer'); ?>" /></p>
...
//IMPORT FUNCTION
add_action( 'init', 'optimizer_import' );
function optimizer_import() {
	if (isset($_POST['import']) && check_admin_referer( 'optimizer_restoreOptions', 'optimizer_restoreOptions' ) ) {
